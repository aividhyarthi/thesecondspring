---
title: "Periods Every Two Weeks? Short Cycles and Frequent Periods in Perimenopause"
...
<div class="ig">
<div class="ig-head">Why Periods Come Closer Together</div>
<div class="ig-body">
<div class="ig-row"><span class="ig-fill-peach">First half of cycle speeds up</span><span>As ovaries age, the follicle matures faster, so ovulation and the next period come sooner</span></div>
<div class="ig-row"><span class="ig-fill-peach">An early-stage sign</span><span>Shorter, more frequent cycles are often one of the first signals perimenopause has begun</span></div>
<div class="ig-row"><span class="ig-fill-muted">The pattern later reverses</span><span>As perimenopause advances, cycles lengthen, skip, and eventually stop</span></div>
<div class="ig-row"><span class="ig-fill-green">Usually normal, but track it</span><span>Common in perimenopause, though very frequent or heavy bleeding needs checking</span></div>
</div>
</div>
