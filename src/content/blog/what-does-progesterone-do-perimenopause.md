---
title: "What Does Progesterone Do During Perimenopause?"
description: "Progesterone is the first hormone to fall in perimenopause — and its decline explains anxiety, poor sleep, heavy periods, and more. A clear guide to what it does and why it matters."
pubDate: 2025-05-22
author: "Journal Desk"
...
1. As women approach their mid-40s, ovarian follicles become less responsive to hormonal signals.
2. Ovulation becomes irregular — some cycles happen without a mature egg being released (**anovulatory cycles**).
3. No ovulation means no corpus luteum forms.
4. No corpus luteum means no progesterone is produced in that cycle.
5. Oestrogen, produced by the follicles themselves, continues — sometimes at normal or even elevated levels.
...
Indian women reach menopause at an average age of **46–47 years** — roughly two to three years earlier than the global average of 51. This means perimenopause and its progesterone-related symptoms often begin in the late 30s or early 40s. For more on the full hormonal picture of this transition, see our guide to [perimenopause explained](/perimenopause-explained).
...
- Shorter cycles (cycle may shorten from 28 days to 21–24 days)
- Clotting
- Mid-cycle spotting

These happen because oestrogen builds up the uterine lining without progesterone to stabilise it. See more about [irregular periods](/guide/symptoms/irregular-periods).
...
Progesterone's sedative effect via GABA-A is lost when levels drop. This is one of the earliest and most disruptive symptoms of perimenopause. Read more about [sleep problems](/guide/symptoms/sleep-problems) in perimenopause.
...
Allopregnanolone — the calming metabolite of progesterone — drops with progesterone. The GABAergic calming signal weakens. Many women describe feeling "wired but tired." See our full symptom guide on [anxiety](/guide/symptoms/anxiety).

**Other symptoms**
- Breast tenderness and swelling
- Bloating and water retention
- Headaches, particularly premenstrual
- Heightened sensitivity to oestrogen's stimulating effects
...
**Synthetic progestogens (progestins)** — such as norethisterone, medroxyprogesterone acetate (MPA), and levonorgestrel — have a different molecular structure. They protect the uterus from oestrogen-driven overgrowth, but they do **not** convert to allopregnanolone. They do not provide the sleep or anti-anxiety benefit. Some progestins actively worsen mood in women who are sensitive to them.

For women in perimenopause who are struggling primarily with sleep and anxiety — and whose symptoms are driven by falling progesterone — body-identical micronised progesterone is the clinically preferred option.
...
Micronised progesterone is available by prescription in India. Ask your gynaecologist specifically for **micronised progesterone capsules** — not a synthetic progestin.

**Indian brand names to ask about:**

- **Susten 200mg** (Sun Pharma) — widely available, oral capsule
- **Gestofit 200mg** (Cipla) — oral capsule, also available as vaginal
- **Lutein 200mg** (Lupin) — oral capsule
...
Progesterone is **not available over the counter** in India for this purpose. It requires a gynaecologist's prescription and appropriate evaluation — including a discussion of your cycle history, symptoms, and whether you need to protect the uterine lining if oestrogen therapy is also being considered.
...
A single "normal" blood test does not rule out functional progesterone deficiency. Clinicians experienced in perimenopause assess symptoms alongside tests.
...
- You are waking consistently between 2–4am without an obvious cause
- Anxiety has increased noticeably in the past 12–24 months without a clear trigger
- Premenstrual symptoms (mood, breast pain, bloating) have worsened
- You are over 38 and experiencing a combination of the above

You do not need to wait until periods stop to have this conversation. Perimenopause is diagnosable on symptoms alone — no blood test is required for diagnosis.

If you are unsure whether your symptoms point to progesterone, [talk to our companion](/chat) for a guided conversation, or [take our symptom check](/quiz) to get a clearer picture of where you are in the perimenopausal transition.
...
Yes. Progesterone can be prescribed on its own, without oestrogen. This is sometimes called **progesterone-only HRT** or **progesterone monotherapy**. It is an option for women in early perimenopause whose main symptoms are poor sleep, anxiety, and heavy periods — without significant hot flushes (which are more oestrogen-driven). Micronised progesterone 100–200mg taken at night has evidence for improving sleep quality and reducing anxiety in this group. It is not appropriate for everyone; your gynaecologist will assess whether it fits your symptom profile.
...
Many women notice an improvement in sleep within the **first one to two weeks** of taking oral micronised progesterone at night. The sedative effect is relatively rapid because it depends on the acute conversion of progesterone to allopregnanolone, not on a slow hormonal recalibration. Full benefit — including reduced nighttime waking — typically stabilises over four to six weeks. If sleep does not improve within six to eight weeks, the dose or formulation may need review.
