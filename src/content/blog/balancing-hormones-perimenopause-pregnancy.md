---
title: "Hormones, Perimenopause, and Carrying a Pregnancy, What You Need to Know"
description: "Getting pregnant in perimenopause is possible but carries specific hormonal challenges. Here is what happens to oestrogen and progesterone during a perimenopausal pregnancy and what medical support looks like."
pubDate: 2026-06-04
author: "Journal Desk"
...
<div class="ig">
  <div class="ig-head">What Progesterone Does in Early Pregnancy</div>
  <div class="ig-body">
    <div class="ig-steps">
      <div class="ig-step"><div class="ig-step-num">1</div><div><strong>Prepares the uterine lining</strong>, progesterone transforms the endometrium into a receptive, nutrient-rich environment where a fertilised egg can implant successfully</div></div>
      <div class="ig-step"><div class="ig-step-num">2</div><div><strong>Prevents uterine contractions</strong>, progesterone suppresses the myometrium (uterine muscle) from contracting, which would expel the developing embryo</div></div>
      <div class="ig-step"><div class="ig-step-num">3</div><div><strong>Supports immune tolerance</strong>, progesterone helps the mother's immune system tolerate the embryo (which is genetically half foreign) without rejecting it</div></div>
      <div class="ig-step"><div class="ig-step-num">4</div><div><strong>Maintains the corpus luteum</strong>, until the placenta takes over at 10–12 weeks, the corpus luteum depends on progesterone signals to continue producing it. Low progesterone early on can initiate a self-reinforcing collapse.</div></div>
    </div>
  </div>
</div>
...
The focus is on whether ovulation is still occurring, what the ovarian reserve looks like (AMH, antral follicle count), and whether progesterone in the luteal phase is sufficient to support implantation. A reproductive endocrinologist or fertility specialist is the right doctor for this evaluation, not a general gynaecologist.

**If you are already pregnant in perimenopause:**
The immediate hormonal focus shifts to:
...
**If you conceived via IVF or egg donation:**
Hormonal support is managed by the fertility clinic from the point of embryo transfer onwards. Oestrogen and progesterone are prescribed as part of the protocol to supplement what the body cannot produce naturally at this stage.
...
<div class="ig">
  <div class="ig-head">Risks That Are Higher in Perimenopausal Pregnancy</div>
  <div class="ig-body">
    <div class="ig-row"><span class="ig-fill-peach">Miscarriage</span><span>The risk of miscarriage rises significantly with age, from approximately 10–15% at age 30 to 30–40% at age 40 and above. Most miscarriages in this age group are due to chromosomal abnormalities in the embryo (aneuploidy), not hormonal failure, though progesterone insufficiency is also a contributing factor.</span></div>
    <div class="ig-row"><span class="ig-fill-peach">Chromosomal abnormalities</span><span>The risk of chromosomal conditions (including Down's syndrome) increases with maternal age. NIPT (non-invasive prenatal testing) from week 10 and detailed first trimester ultrasound screening are standard recommendations for pregnancies in the 40s.</span></div>
    <div class="ig-row"><span class="ig-fill-peach">Gestational diabetes</span><span>Women in their 40s, particularly with any degree of insulin resistance (which is more common in perimenopausal women), have higher rates of gestational diabetes. Early glucose screening and dietary management matter.</span></div>
    <div class="ig-row"><span class="ig-fill-peach">Hypertension and pre-eclampsia</span><span>Blood pressure complications in pregnancy are more common with advancing maternal age. Regular blood pressure monitoring and early recognition of pre-eclampsia symptoms (headache, visual changes, swelling) is essential.</span></div>
    <div class="ig-row"><span class="ig-fill-muted">Placenta praevia and abruption</span><span>Both are more common with age and with multiple previous pregnancies. Your obstetrician will monitor placental position from mid-pregnancy onwards.</span></div>
    <div class="ig-row"><span class="ig-fill-muted">Caesarean section</span><span>The rate of caesarean delivery is higher in older mothers, partly due to the above complications and partly due to changes in uterine contractility with age.</span></div>
  </div>
</div>
...
[Our community](/community) is here if you want to see how other women have handled similar situations before an appointment.
