---
title: "Talking to Your Boss About Perimenopause: A Practical Guide"
description: "Deciding whether, when, and how to tell your workplace about perimenopause is a real dilemma for working women in India. Here is a practical, honest guide to having that conversation, and what your options are if you would rather not."
pubDate: 2026-07-09
author: "Journal Desk"
image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=1200&q=80"
imageAlt: "Working woman preparing to discuss perimenopause with her manager"
tags: ["life", "working women", "workplace", "when to see doctor"]
...
<div class="ig">
<div class="ig-head">Deciding Whether to Disclose</div>
<div class="ig-body">
<div class="ig-row"><span class="ig-fill-green">You are never obliged to</span><span>You can request flexibility or adjustments without ever naming the reason</span></div>
<div class="ig-row"><span class="ig-fill-muted">Consider your workplace culture</span><span>Some environments are genuinely receptive; others are not, and that is worth honestly assessing first</span></div>
<div class="ig-row"><span class="ig-fill-muted">Start with HR if unsure</span><span>A confidential conversation with HR can be a safer first step than going straight to your manager</span></div>
<div class="ig-row"><span class="ig-fill-green">Lead with solutions</span><span>Framing the conversation around what helps you keep performing well tends to land best</span></div>
</div>
</div>

## How to Prepare

**Get clear on what you actually need.** Before any conversation, identify the specific adjustments that would help: flexible start times if sleep is broken, the option to step away briefly during a flash, fewer very early or late meetings, the ability to work from home occasionally, or simply understanding if your output dips on a hard day. Specific, practical asks are far easier for a manager to say yes to than a vague "I'm struggling."
...
**Choose your framing.** You can be as specific or as general as you are comfortable with. Some women say plainly, "I'm going through perimenopause, and it's affecting my sleep and concentration." Others prefer, "I'm dealing with a health matter that affects my sleep and energy, and here is what would help." Both are legitimate; use whichever feels right for you and your workplace.

## What to Say

A simple structure works well: briefly name that something is affecting you, mention it is temporary and manageable, and lead with the specific adjustment that would help. For example: "I wanted to let you know I'm going through some health changes that are affecting my sleep and focus at the moment. It's manageable, and I expect it to improve, but it would really help if I could shift my start time by an hour for now." This keeps the focus on solutions, not on asking for sympathy, and tends to be received more constructively.

## If the Response Is Not Supportive

Not every manager or workplace will respond well, and that is a painful but real possibility. If this happens, it does not mean you were wrong to try. Consider whether HR, a different manager, or an employee assistance programme, where available, might offer another route. Document your performance and any adjustments discussed, in case you need to refer back to them. And remember that a poor response reflects the workplace's limitations, not a failing in you.
