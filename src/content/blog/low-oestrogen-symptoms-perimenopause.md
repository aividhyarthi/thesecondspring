---
title: "Low Oestrogen Symptoms: What Your Body Is Trying to Tell You"
...
<div class="ig">
<div class="ig-head">Where Oestrogen Works in the Body</div>
<div class="ig-body">
<div class="ig-row"><span class="ig-fill-peach">Brain</span><span>Supports serotonin, memory, and the temperature thermostat — low oestrogen brings mood swings, brain fog, and hot flashes</span></div>
<div class="ig-row"><span class="ig-fill-peach">Bones and joints</span><span>Protects bone density and cushions joints — decline brings aches and faster bone loss</span></div>
<div class="ig-row"><span class="ig-fill-muted">Skin and hair</span><span>Maintains collagen and moisture — low oestrogen means dryness, thinning, and slower healing</span></div>
<div class="ig-row"><span class="ig-fill-muted">Vagina and bladder</span><span>Keeps tissue thick and lubricated — decline causes dryness and urinary changes</span></div>
<div class="ig-row"><span class="ig-fill-green">All one cause</span><span>These are not separate illnesses — they are a single hormonal shift showing up everywhere</span></div>
</div>
</div>
