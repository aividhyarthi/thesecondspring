---
title: "Early and Premature Menopause: When It Happens Before 45"
...
<div class="ig">
<div class="ig-head">Early and Premature Menopause at a Glance</div>
<div class="ig-body">
<div class="ig-row"><span class="ig-fill-peach">Early menopause</span><span>Menopause between 40 and 45</span></div>
<div class="ig-row"><span class="ig-fill-peach">Premature menopause (POI)</span><span>Menopause before 40 — sometimes in the 20s or 30s</span></div>
<div class="ig-row"><span class="ig-fill-muted">Often missed</span><span>Symptoms are wrongly blamed on stress because doctors do not expect it at a young age</span></div>
<div class="ig-row"><span class="ig-fill-green">Treatment matters</span><span>HRT is usually recommended to at least the natural age of menopause, to protect health</span></div>
</div>
</div>
...
- **Genetic and family history** — early menopause can run in families.
...
The symptoms are the same as menopause at any age: irregular then absent periods, hot flashes, night sweats, mood changes, anxiety, sleep problems, brain fog, vaginal dryness, and reduced libido. The difference is the age at which they appear, which is exactly why they are so often missed or misattributed to stress, overwork, or "it can't be that, you're too young."
