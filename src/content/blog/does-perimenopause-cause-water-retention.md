---
title: "Does Perimenopause Cause Water Retention?"
...
<div class="ig">
  <div class="ig-head">💧 How Perimenopause Causes Fluid Retention</div>
  <div class="ig-body">
    <div class="ig-steps">
      <div class="ig-step">
        <div class="ig-step-num">1</div>
        <div class="ig-step-text"><strong>Progesterone falls first.</strong> Progesterone is a natural diuretic — it signals the kidneys to excrete sodium and fluid. As it declines in early perimenopause, this diuretic effect is lost.</div>
      </div>
      <div class="ig-step">
        <div class="ig-step-num">2</div>
        <div class="ig-step-text"><strong>Oestrogen surges unopposed.</strong> Oestrogen causes the kidneys to retain sodium. Without progesterone's counterbalancing effect, oestrogen-driven sodium retention goes unchecked.</div>
      </div>
      <div class="ig-step">
        <div class="ig-step-num">3</div>
        <div class="ig-step-text"><strong>Water follows sodium.</strong> Sodium draws water into the tissues. This is basic physiology — wherever sodium is retained, water accumulates alongside it.</div>
      </div>
      <div class="ig-step">
        <div class="ig-step-num">4</div>
        <div class="ig-step-text"><strong>Fluid builds in tissues.</strong> The result is oedema — fluid in the tissues of the face, hands, abdomen, and lower legs. This is what creates the bloating, puffiness, and weight fluctuation.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="ig">
  <div class="ig-head">⚖️ Water Retention vs Fat Gain — How to Tell</div>
  <div class="ig-body">
    <div class="ig-cols">
      <div class="ig-col">
        <p class="ig-col-title green">Signs It Is Water Retention</p>
        <ul>
          <li>Weight changes by 1–3 kg overnight</li>
          <li>Puffiness visible in face and hands</li>
          <li>Rings and shoes suddenly tight</li>
          <li>Better after your period starts</li>
          <li>Worse before period, in heat, with salt</li>
        </ul>
      </div>
      <div class="ig-col">
        <p class="ig-col-title peach">Signs It Is Fat Redistribution</p>
        <ul>
          <li>Gradual, consistent increase over months</li>
          <li>Concentrated around abdomen</li>
          <li>Not affected by menstrual cycle</li>
          <li>Not relieved by urinating more</li>
          <li>Clothes consistently tighter, not fluctuating</li>
        </ul>
      </div>
    </div>
    <p class="ig-caption">Both can happen simultaneously in perimenopause — the abdominal weight gain from fat redistribution combined with cyclical fluid retention around it.</p>
  </div>
</div>
